bootstrap:
	...
	-PGPASSWORD=postgres docker exec -it adsmanagerservices_postgresdb_1 psql -h localhost -U postgres -p 5432 -c "CREATE DATABASE balance"
	-PGPASSWORD=postgres docker exec -it adsmanagerservices_postgresdb_1 psql -h localhost -d balance -U postgres -p 5432 \
